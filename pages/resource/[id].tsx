...
import { BookmarkBorderOutlined, CheckOutlined, HourglassEmptyOutlined } from '@material-ui/icons'
				...
				{!!authState && (
					<Toolbar>
						<Button
							...
							disabled={isBookmarked === null ? true : isBookmarked ? true : false}
							startIcon={
								isBookmarked === null ? (
						...
						>
							{isBookmarked === null ? 'loading' : isBookmarked ? 'Bookmarked' : 'Bookmark'}
						</Button>
					</Toolbar>
				)}
			</Container>
